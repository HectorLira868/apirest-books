...
public class CategoriaRestController {
	...
	public ResponseEntity<CategoriaResponseRest> consultarId(@PathVariable Long id){
		ResponseEntity<CategoriaResponseRest> response = service.buscarId(id);
		
		return response;
	}
	
	@PostMapping("/categorias")
	public ResponseEntity<CategoriaResponseRest> crear(@RequestBody Categoria categoria){
		ResponseEntity<CategoriaResponseRest> response = service.crear(categoria);
